<template>
  <footer class="w-full bg-[#05060a] text-white py-2 md:py-12 relative z-10 mt-0 md:mt-0">
    <!-- top-strip only on desktop to avoid large block on mobile -->
    <div class="hidden md:block absolute top-0 left-0 right-0 h-6 bg-[#05060a] pointer-events-none" aria-hidden="true"></div>
    <div class="max-w-full md:max-w-6xl mx-auto px-0">
          ...
          <div class="flex items-center justify-center md:justify-start gap-2 md:gap-3">
            <a href="https://www.linkedin.com/in/riccardo-cassis/" target="_blank" rel="noopener" aria-label="LinkedIn" class="inline-flex items-center justify-center w-4 h-4 md:w-8 md:h-8 text-white/70 hover:text-white hover:scale-[1.05] transition-all duration-200">
              <svg class="w-3 h-3 md:w-5 md:h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.5 8h4V24h-4zM8.98 8h3.84v2.2h.05c.54-1 1.86-2.2 3.83-2.2 4.1 0 4.86 2.7 4.86 6.2V24h-4v-7.2c0-1.7 0-3.9-2.4-3.9-2.4 0-2.77 1.9-2.77 3.8V24h-4z"/>
              </svg>
            </a>
            <a href="https://github.com/Riccardocassis" target="_blank" rel="noopener" aria-label="GitHub" class="inline-flex items-center justify-center w-4 h-4 md:w-8 md:h-8 text-white/70 hover:text-white hover:scale-[1.05] transition-all duration-200">
              <svg class="w-3 h-3 md:w-5 md:h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                <title>GitHub</title>
