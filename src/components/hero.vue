        ...
        <div class="order-1 md:col-span-6 flex items-center justify-start">
          <div class="relative w-full flex justify-start -mx-6 md:mx-0">
            <div class="w-[80%] sm:w-[70%] md:w-[45%]">
              ...
              <!-- Picture responsive ottimizzata -->
              <picture class="block relative z-10">
                <template v-for="source in heroRiccardo.sources" :key="source.srcset">
                  <source :srcset="source.srcset" :type="source.type" />
                </template>

                <img
                  :src="heroRiccardo.img.src"
            ...
            <div class="max-w-xl md:text-left text-center">
              ...
              <div class="mt-6 md:mt-8 flex justify-center md:justify-start gap-4 md:gap-6">
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  class="inline-flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 text-white/70 hover:text-white hover:scale-105 transition-all duration-200"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Behance"
                  class="inline-flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 text-white/70 hover:text-white hover:scale-105 transition-all duration-200"
                >
...
/* IMPORT IMMAGINE OTTIMIZZATA */
import heroRiccardo from '../assets/hero-riccardo.webp?w=800;1200;1600;2000&format=webp;jpeg&as=picture'
