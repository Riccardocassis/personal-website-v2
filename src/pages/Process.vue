<template>
  <main class="page-bg text-white min-h-screen">
    <!-- Hero -->
    <header class="pt-6 pb-24 px-6 md:px-12 text-center max-w-4xl mx-auto" role="region" aria-label="Il mio processo di lavoro - Hero">
      <p class="text-[#00BFFF] font-medium mb-4">{{ $t('process.eyebrow') }}</p>
      <h1 class="text-3xl md:text-5xl font-extrabold leading-tight mb-6">{{ $t('process.title') }}</h1>
      <p class="text-gray-300 max-w-2xl mx-auto text-lg md:text-xl mb-6">{{ $t('process.subtitle') }}</p>
      <p class="text-gray-400 max-w-2xl mx-auto mb-8">{{ $t('process.subtitle2') }}</p>
    ...
    <section class="py-12 md:py-24 px-6 md:px-12 max-w-6xl mx-auto" aria-labelledby="timeline-title">
      <h2 id="timeline-title" class="text-2xl md:text-3xl font-bold text-white mb-6 text-center">{{ $t('process.timelineTitle') }}</h2>
    ...
    <!-- I miei valori -->
    <section class="py-12 md:py-20 px-6 md:px-12 max-w-6xl mx-auto" aria-labelledby="values-title">
      <h2 id="values-title" class="text-2xl md:text-3xl font-bold text-white mb-8 text-center">{{ $t('process.valuesTitle') }}</h2>
    ...
    <!-- CTA finale -->
    <section class="py-20 px-6 md:px-12 mt-12">
      <div class="max-w-4xl mx-auto rounded-3xl overflow-hidden" style="background: linear-gradient(90deg,#00BFFF,#0099CC);">
